...
// MARK: - PREVIEW CORREGIDO SIN VOID / () PARA XCODE 13
struct ServiciosView_Previews: PreviewProvider {
    static var previews: some View {
        // Inicializamos el contenedor de pruebas de forma limpia
        ServiciosView()
            .previewDisplayName("Servicios Vista Real")
    }
}
